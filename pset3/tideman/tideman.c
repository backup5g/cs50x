...
/* Some parts I have very difficult to understand, so I picked a code in GitHub to refference. 
   To me, the important part is learn, and after I picked this code to refference I understand
   100%, so my task is complete.
*/
